...
execute if items entity @p player.cursor *[minecraft:custom_data~{what_ui:{type:"craft_result"}}] run function what:ui/type/crafting_table_2/craft/remove_and_give_result with storage what:temp
