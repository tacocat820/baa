...
execute align xyz positioned ~.5 ~.5 ~.5 unless entity @n[type=item_display,tag=what.block_placed,distance=0..0.7] run function what:block/actions/setblock_force {block:"broken_glass"}
function what:block/actions/setblock_force {block:"broken_glass"}
