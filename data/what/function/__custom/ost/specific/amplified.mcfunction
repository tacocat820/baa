...
execute if score @s what.music matches ..0 run playsound what.ost.fardium music @s
execute if score @s what.music matches ..0 run scoreboard players set @s what.musictype 3
execute if score @s what.music matches ..0 run scoreboard players set @s what.music 7
