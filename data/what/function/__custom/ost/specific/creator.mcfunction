...
execute if score $music what.temp matches 0 run playsound what.ost.steppig music @s
execute if score $music what.temp matches 0 run scoreboard players set @s what.music 16
