...
loot give @s loot {pools:[{rolls:1,entries:[{type:"minecraft:loot_table",value:"what:items/toast_crumbs",functions:[{function:"minecraft:set_count",count:{min:34,max:64}}]}]}]}