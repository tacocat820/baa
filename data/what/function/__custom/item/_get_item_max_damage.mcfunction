...
$execute store result score max_damage what.temp run data get entity @s $(slot_nbt).components.minecraft:max_damage
...
$execute if items entity @s $(slot) *[minecraft:max_damage=500] run return run scoreboard players set max_damage what.temp 500
