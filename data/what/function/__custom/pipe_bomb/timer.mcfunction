...
function what:timer/_ {func:'what:__custom/explode', loop_func:'', time:136}

#scoreboard players set @s what.timer 13
#data modify entity @s item.components."minecraft:custom_data".timer set value {func: "what:__custom/explode"}
