...
damage @s 1
$execute if score @s what.etc.teeth_count matches 0.. run return run give @s bone[custom_name='["",{"text":"tooth","italic":false}]'] $(x)
...
data modify storage what:temp id set value 'bone[custom_name=\'["",{"text":"tooth","italic":false}]\']'
