...
execute if score @s what.ent.action matches 12 run tellraw @a[distance=0..60] [{"translate":"what.message.bgb.ready.11"}]
execute if score @s what.ent.action matches 12 as @a[distance=0..14] at @s run function what:__custom/bgb/inventoryl
