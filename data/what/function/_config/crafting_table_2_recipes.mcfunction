...
data modify storage what:config recipes.e append value {craft:{0: "minecraft:iron_block", 1: "minecraft:iron_block", 2: "minecraft:iron_block", 3: "minecraft:iron_block", 4: "demon_core", 5: "minecraft:iron_block", 6: "minecraft:iron_block", 7: "minecraft:iron_block", 8: "minecraft:iron_block"}, loot:"what:blocks/nuke", count:1}
data modify storage what:config recipes.e append value {craft:{0: "air", 1: "diamond_2", 2: "diamond_2", 3: "air", 4: "minecraft:stick", 5: "air", 6: "air", 7: "minecraft:stick", 8: "air"}, loot:"what:items/diamond_hoe", count:1}
...
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "minecraft:dragon_egg"}], loot:"minecraft:blocks/obsidian", count:9}
...
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "uranium_block"}], loot:"what:items/uranium", count:8}
...
data modify storage what:config recipes.s append value {craft:[{count: 2, id: "broken_glass"}, {count: 7, id: "air"}], minecraft_id:"glass", count:1}
...
data modify storage what:config recipes.s append value {craft:[{count: 4, id: "air"}, {count: 1, id: "minecraft:stick"}, {count: 4, id: "meth"}], loot:"what:items/meth_lollipop", count:1}
...
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "redstone_block_2"}], loot:"what:blocks/redstone_2", count:9}
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "diamond_block_2"}], loot:"what:items/diamond_2", count:9}
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "gold_block_2"}], loot:"what:items/gold_2", count:9}

data modify storage what:config recipes.s append value {craft:[{count: 9, id: "minecraft:leather"}], loot:"what:blocks/leather_block", count:1}
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "leather_block"}], minecraft_id:"leather", count:9}
data modify storage what:config recipes.s append value {craft:[{count: 9, id: "minecraft:rotten_flesh"}], loot:"what:blocks/rotten_flesh_block", count:1}
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "rotten_flesh_block"}], minecraft_id:"rotten_flesh", count:9}

data modify storage what:config recipes.s append value {craft:[{count: 2, id: "dust"}, {count: 7, id: "air"}], loot:"what:blocks/dust_carpet", count:2}
data modify storage what:config recipes.s append value {craft:[{count: 8, id: "air"}, {count: 1, id: "cursed_wood"}], loot:"what:blocks/cursed_planks", count:4}

data modify storage what:config recipes.s append value {craft:[{count: 8, id: "meth"}, {count: 1, id: "minecraft:barrel"}], loot:"what:blocks/barrel_with_meth", count:1}
data modify storage what:config recipes.s append value {craft:[{count: 7, id: "air"}, {count: 1, id: "minecraft:iron_pickaxe"}, {count: 1, id: "RCWIP"}], minecraft_id:"minecraft:rail", count:1}
...
data modify storage what:config recipes.s append value {craft:[{count: 7, id: "air"}, {count: 1, id: "demon_core"}, {count: 1, id: "minecraft:stick"}], loot:"what:items/demon_core_mace", count:1}
