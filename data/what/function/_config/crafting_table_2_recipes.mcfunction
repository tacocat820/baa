...
data modify storage what:config recipes append value {type:s,craft:[{count: 4, id: "dust"}, {count: 5, id: "air"}], loot:"what:blocks/dust", count:1}
...
data modify storage what:config recipes append value {type:s,craft:[{count: 7, id: "air"}, {count: 1, id: "minecraft:iron_pickaxe"}, {count: 1, id: "RCWIP"}], minecraft_id:"minecraft:rail", count:1}
