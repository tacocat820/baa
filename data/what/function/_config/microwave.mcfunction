...
data modify storage what:config microwave.villager_meat_raw set value {loot_table: "what:items/villager_meat" }
data modify storage what:config microwave.villager_meat set value {loot_table: "what:items/dust" }
...
data modify storage what:config microwave.pig_corpse set value {loot_table: "what:items/cooked_pig_corpse"}
