...
##(not) deleting "minecraft:" namespace prefix
execute if data storage what:temp {item_prefix: "minecraft:"} run return run data modify storage what:temp txt.text set string storage what:temp txt.text 0
