...
execute if data storage what:temp recipe{type:"e"} run function what:_config/recipe_book/description/e
execute if data storage what:temp recipe{type:"s"} run function what:_config/recipe_book/description/s
#----
