...
#21th may 2026
#- execute store result entity @s item.components."minecraft:custom_data".block_id int 1 run scoreboard players get $n what.block_id
data modify entity @s item.components."minecraft:custom_data".block_id set from storage what:temp block_id
#
