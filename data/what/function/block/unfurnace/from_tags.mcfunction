...
$execute if data storage what:config unfurnace.'$(Tags)'.command run return run function what:block/unfurnace/command with storage what:config unfurnace.'$(Tags)'
