...
$execute if data storage what:config unfurnace.$(what_type).command run return run function what:block/unfurnace/command with storage what:config unfurnace.$(what_type)
