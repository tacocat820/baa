...
execute unless data block ~ ~ ~ Items[0].components.minecraft:custom_data.what_type run function what:block/microwave/from_config with block ~ ~ ~ Items[0]
execute if data block ~ ~ ~ Items[0].components.minecraft:custom_data.what_type run function what:block/microwave/from_config_b with block ~ ~ ~ Items[0].components.minecraft:custom_data
