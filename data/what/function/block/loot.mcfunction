...
execute if score cmd what.temp matches 32004 run return run summon item ~ ~ ~ {Item:{components: {"minecraft:custom_model_data": 32000, "minecraft:custom_data": {what_type: "meth"}, "minecraft:item_name": '{"extra":[{"italic":false,"translate":"what.item.meth"}],"text":""}'}, count: 3, id: "minecraft:clock"}}
...
#32008 и 32009
execute if score cmd what.temp matches 32010 run return run summon item ~ ~ ~ {Item:{components: {"minecraft:entity_data": {id: "item_frame", Invisible: 1b, Tags: ["what.block", "globe"]}, "minecraft:custom_model_data": 32010, "minecraft:item_name": '{"extra":[{"italic":false,"translate":"what.block.globe"}],"text":""}'}, count: 1, id: "minecraft:item_frame"}}