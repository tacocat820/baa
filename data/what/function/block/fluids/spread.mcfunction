...
execute if block ~ ~-1 ~ #what:solid_blocks_placeable_on positioned ~ ~-1 ~ run function what:block/fluids/down with entity @s item.components.minecraft:custom_data
