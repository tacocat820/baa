...
execute as @n[tag=what.block_placed,tag=microwave] if score @s what.timer matches 0..10 run function what:block/microwave/convert
...
data modify entity @n[tag=what.block_placed,tag=microwave] item.components.minecraft:custom_data.microwave_item set value {}
