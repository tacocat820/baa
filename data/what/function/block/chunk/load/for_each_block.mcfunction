...
data modify storage what:temp block_data set from entity @s data.chunk_data[0]

scoreboard players remove $blocks_left what.temp 1
...
execute if score $blocks_left what.temp matches 0.. run function what:block/chunk/load/for_each_block