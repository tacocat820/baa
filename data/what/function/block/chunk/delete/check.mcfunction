...
execute if score $blocks_left what.temp matches ..64 run function what:block/chunk/load/for_each_block
execute if score $blocks_left what.temp matches ..64 run kill @s
