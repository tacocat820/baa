...
execute if score chunks_count what.temp matches 20.. as @e[distance=45..400,type=marker, tag=what.blocks_chunk] at @s unless entity @a[distance=0..30] run function what:block/chunk/create/_