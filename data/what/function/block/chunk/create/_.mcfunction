...
execute as @e[distance=0..12, type=item_display, tag=what.block_placed, tag=!what.no_chunking,tag=!falling,   limit=256] run function what:block/chunk/create/get_data
