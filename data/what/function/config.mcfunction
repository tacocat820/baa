...
data modify storage what:config inter.door_3 set value {target: "what:block/door_3/run",attack: "what:block/actions/destroy_block"}
data modify storage what:config inter.cinema_chair set value {target: "what:block/chairs/sit", attack: "what:__custom/block/destroy_if_in_surv"}
data modify storage what:config inter.blue_chair set value {target: "what:block/chairs/sit", attack: "what:__custom/block/destroy_if_in_surv"}
