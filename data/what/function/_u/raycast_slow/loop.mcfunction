...
execute if entity @e[dx=0,dy=0,dz=0,type=!#what:non_mobs,tag=!what.raycaster_slow,limit=1] run return run function what:_u/raycast_slow/end with entity @s data
