...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=1,dy=1,dz=1,type=#what:aquaphobic,type=!#what:non_mobs] run damage @s 8 minecraft:drown by @p[tag=what.raycaster]
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=1,dy=1,dz=1,type=!#aquatic,type=!#what:non_mobs] run damage @s 3 minecraft:drown by @p[tag=what.raycaster]
