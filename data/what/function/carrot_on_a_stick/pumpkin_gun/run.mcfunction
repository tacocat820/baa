...
function what:_u/raycast/start {loop_func:"what:carrot_on_a_stick/pumpkin_gun/_ray_particle", end_func:"what:carrot_on_a_stick/pumpkin_gun/ray_end", distance:256}