...
#v2
execute anchored eyes positioned ^ ^ ^2 run function what:_u/proj/launch {V:400, g:10, loop_func:"what:carrot_on_a_stick/melon_gun/particles", end_func:"what:carrot_on_a_stick/melon_gun/explode", item:{id:"melon"}}
