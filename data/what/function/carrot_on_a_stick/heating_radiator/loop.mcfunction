...
execute store result storage what:temp size3 float 0.15 run scoreboard players get dist what.temp
execute store result storage what:temp size3_half float -0.075 run scoreboard players get dist what.temp

execute store result storage what:temp damage int 0.11 run scoreboard players get @s what.raycast_slow
