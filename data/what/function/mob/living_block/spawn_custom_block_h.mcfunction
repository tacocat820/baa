...
tag @n[type=item_display, tag=what.b_ready_to_sit] add what.custom_living_block
data merge entity @n[type=item_display, tag=what.b_ready_to_sit] {transformation:{translation:[0f,-0.5f,0f]}}
