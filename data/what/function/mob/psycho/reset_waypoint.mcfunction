...
execute at @a[limit=1,sort=nearest,distance=0..50,gamemode=!spectator] run function what:mob/_pathfinding/set
execute if predicate what:random1 run function what:mob/psycho/state/angry