summon wandering_trader ~ ~ ~ {Tags:["what.temp_new","what.bgb_intro.steve_jobs","tick1s"]}
...
effect give @n[tag=what.temp_new] resistance infinite 25 true
effect give @n[tag=what.temp_new] slowness infinite 25 true
