...
attribute @n[tag=what.temp_new] generic.attack_damage base set 999
attribute @n[tag=what.temp_new] generic.scale base set 2
attribute @n[tag=what.temp_new] generic.gravity base set 0.04
