...
summon wandering_trader ~ ~ ~ {Tags:["what.temp_new","what.ent.psycho","tick1s","what.checked"],DeathLootTable:"what:loot/psycho",Offers:{Recipes:[{buy:{id:'air',count:1b},sell:{id:'air',count:1b}}]}}
