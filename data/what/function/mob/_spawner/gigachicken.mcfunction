...
attribute @n[tag=what.temp_new] minecraft:scale base set 1.8
attribute @n[tag=what.temp_new] movement_speed base set 0.25
attribute @n[tag=what.temp_new] max_health base set 100
attribute @n[tag=what.temp_new] attack_damage base set 8
attribute @n[tag=what.temp_new] attack_knockback base set 8
