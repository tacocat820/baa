summon wandering_trader ~ ~ ~ {Tags:["what.temp_new","what.wwtb.cpu","what.wwtb.psycho","tick1s","what.checked"],DeathLootTable:"what:items/rock",NoAI:1b}
...
execute as @n[tag=what.temp_new] at @s run function what:mob/__spawn {"type":"wwtb_psycho"}
