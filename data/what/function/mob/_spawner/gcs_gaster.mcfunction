summon wandering_trader ~ ~ ~ {Tags:["what.temp_new","what.gcs.gaster","tick1s"], Invulnerable:1b}
...
data merge entity @n[tag=what.temp_new] {DeathLootTable:"what:items/hairdryer"}
