...
execute unless entity @e[tag=what.ent.homeless_possessor,distance=0..1] run summon wandering_trader ~ ~ ~ {Tags:[what.ai,what.ent.homeless_possessor,tick1s],attributes:[{id:"generic.scale",base:0.3}],Silent:1b}
