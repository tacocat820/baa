...
execute unless entity @e[tag=what.ent.homeless_possessor,distance=0..1] run summon wandering_trader ~ ~ ~ {Tags:[what.ai,what.ent.homeless_possessor],Attributes:[{Name:"generic.scale",Base:0.1f}],Silent:1b}
