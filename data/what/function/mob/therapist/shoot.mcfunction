...
execute positioned ~ ~1.6 ~ run function what:_u/raycast_slow/start {speed:3, max_distance:200, loop_func:"what:mob/pigeon/laser_loop", end_func:"what:mob/therapist/send"}
