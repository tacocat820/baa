execute at @s as @n[type=item_display,tag=what.disp,distance=0..4] run function what:mob/_anim/_ {change:1,frames:24,cmd:32058}

scoreboard players set @s what.ent.task 1
#scoreboard players set @s what.ent.action 60
