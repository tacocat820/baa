execute unless score @s what.ent.action matches 1 if entity @a[distance=0..3] run scoreboard players add @s what.ent.action 1
execute unless entity @a[distance=0..6] run scoreboard players reset @s what.ent.action
